<script lang="ts">
    ...
    import TodoDeadlineCategory from './TodoDeadlineCategory.svelte';
...
<div class="mt-6 grid grid-cols-1 gap-6">
    <div class="flex justify-between items-center mb-2">
        <div>
            <h2 class="text-xl font-bold text-gray-800">Organize Your Tasks</h2>
            <p class="text-gray-600">Manage your tasks by deadline - focus on what needs to be done first</p>
        </div>
        <div class="relative">
            <select 
